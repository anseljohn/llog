...
def log_message(message):
    log = simple_logger.llog(message)
...
def print_usage():
    print("Usage:")
    print("  llog <message>                # Log a message")
    print("  llog -i                       # Open editor for a detailed log message")
    print("  llog --summarize <range>      # Summarize logs for a range (e.g. 'today', 'this month', 'this week')")
    print("  llog --reset                  # Delete all logs")
